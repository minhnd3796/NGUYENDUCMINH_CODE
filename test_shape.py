...
def main(argv=None):
    ...
    shape = tf.shape(pred_annotation)
    sess = tf.Session()
    print(sess.run(shape, feed_dict={image:imread("../ISPRS_semantic_labeling_Vaihingen/train/top_mosaic_09cm_area1_0.tif")[np.newaxis,:,:,:], keep_probability: 1.0}))
    print('ok')
