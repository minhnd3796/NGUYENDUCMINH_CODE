...
def infer_little_img(input_image_path,patch_size=224,stride_ver=56,stride_hor=56):
    ...
    image = tf.placeholder(tf.float32, shape=[1, IMAGE_SIZE, IMAGE_SIZE, 15], name="input_image")
