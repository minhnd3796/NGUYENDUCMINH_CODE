...
if __name__ == "__main__":
    #tf.app.run()
    np.save('2_ckp1.npy', infer_little_img("../ISPRS_semantic_labeling_Vaihingen/top/top_mosaic_09cm_area2.tif"))
    np.save('4_ckp1.npy', infer_little_img("../ISPRS_semantic_labeling_Vaihingen/top/top_mosaic_09cm_area4.tif"))
    np.save('6_ckp1.npy', infer_little_img("../ISPRS_semantic_labeling_Vaihingen/top/top_mosaic_09cm_area6.tif"))
    np.save('8_ckp1.npy', infer_little_img("../ISPRS_semantic_labeling_Vaihingen/top/top_mosaic_09cm_area8.tif"))
    np.save('10_ckp1.npy', infer_little_img("../ISPRS_semantic_labeling_Vaihingen/top/top_mosaic_09cm_area10.tif"))
    np.save('12_ckp1.npy', infer_little_img("../ISPRS_semantic_labeling_Vaihingen/top/top_mosaic_09cm_area12.tif"))
    np.save('14_ckp1.npy', infer_little_img("../ISPRS_semantic_labeling_Vaihingen/top/top_mosaic_09cm_area14.tif"))
    np.save('16_ckp1.npy', infer_little_img("../ISPRS_semantic_labeling_Vaihingen/top/top_mosaic_09cm_area16.tif"))
    np.save('20_ckp1.npy', infer_little_img("../ISPRS_semantic_labeling_Vaihingen/top/top_mosaic_09cm_area20.tif"))
    np.save('22_ckp1.npy', infer_little_img("../ISPRS_semantic_labeling_Vaihingen/top/top_mosaic_09cm_area22.tif"))
    np.save('24_ckp1.npy', infer_little_img("../ISPRS_semantic_labeling_Vaihingen/top/top_mosaic_09cm_area24.tif"))
    np.save('27_ckp1.npy', infer_little_img("../ISPRS_semantic_labeling_Vaihingen/top/top_mosaic_09cm_area27.tif"))
    np.save('29_ckp1.npy', infer_little_img("../ISPRS_semantic_labeling_Vaihingen/top/top_mosaic_09cm_area29.tif"))
    np.save('31_ckp1.npy', infer_little_img("../ISPRS_semantic_labeling_Vaihingen/top/top_mosaic_09cm_area31.tif"))
    np.save('33_ckp1.npy', infer_little_img("../ISPRS_semantic_labeling_Vaihingen/top/top_mosaic_09cm_area33.tif"))
    np.save('35_ckp1.npy', infer_little_img("../ISPRS_semantic_labeling_Vaihingen/top/top_mosaic_09cm_area35.tif"))
    np.save('38_ckp1.npy', infer_little_img("../ISPRS_semantic_labeling_Vaihingen/top/top_mosaic_09cm_area38.tif"))
# 2
# 4
# 6
# 8
